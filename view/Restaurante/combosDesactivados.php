...
<html>
	<head>
		<title>Recuperacion de Combos</title>
...
<script type="text/javascript" src="../../pluggins/sweetalert-master/dist/sweetalert.min.js"></script>	
		...
		<script type="text/javascript" src="../../resources/js/recuperacionCombo.js"></script>
	</head>
	<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item " >
        <a class="nav-link" href="dashboardRestaurante.php">Inicio <span class="sr-only">(current)</span></a>
      </li>
    ...
    <a href="../../app/cerrarSesion.php"><button class="btn btn-outline-danger my-2 my-sm-0" type="submit">Cerrar sesión</button></a>
		...
		<div class="container">
				...
				<div class="col-md-9" style="margin-top: 10px;">
		            <p class="robo" style="font-weight: 300; margin-bottom: 0px; font-size: 30px;">Combos</p>
		            <p class="robo" style="font-weight: 300; font-size: 14px; height: 40px;">Recuperacion de Combos</p>
        		</div>
              ...
              <th>Fecha de ultima modificacion</th>              
				 		...
				 		<?php 
			 				...
			 				$data = $objProducto->getAllDesactivados();
			 				if ($data!=false) {
